...
def main():
    ...
    tree_frame.grid(row=7, column=0, columnspan=3)
    ...
    lbl_pagination.grid(row=8, column=0, columnspan=2)

    tk.Button(root, text="Página Anterior", command=previous_page).grid(row=9, column=0)
    tk.Button(root, text="Próxima Página", command=next_page).grid(row=9, column=1)

    # Botões
    tk.Button(root, text="Adicionar Livro", command=adicionar_livro_gui).grid(row=10, column=0, pady=5)
    tk.Button(root, text="Listar Livros Disponíveis", command=lambda: listar_livros_treeview(1)).grid(row=10, column=1, pady=5)

    tk.Label(root, text="Número do Livro para Pesquisar").grid(row=11, column=0)
    entry_numero_livro_pesquisa = tk.Entry(root)
    entry_numero_livro_pesquisa.grid(row=11, column=1)
    tk.Label(root, text="Nome para Pesquisar").grid(row=12, column=0)
    entry_nome_pesquisa = tk.Entry(root)
    entry_nome_pesquisa.grid(row=12, column=1)
    tk.Label(root, text="Editora para Pesquisar").grid(row=13, column=0)
    entry_editora_pesquisa = tk.Entry(root)
    entry_editora_pesquisa.grid(row=13, column=1)
    tk.Label(root, text="Autor para Pesquisar").grid(row=14, column=0)
    entry_autor_pesquisa = tk.Entry(root)
    entry_autor_pesquisa.grid(row=14, column=1)
    tk.Label(root, text="Disponibilidade para Pesquisar").grid(row=15, column=0)
    ...
    entry_disponibilidade_pesquisa.grid(row=15, column=1)
    ...
    tk.Button(root, text="Número do Livro para Marcar Disponibilidade").grid(row=17, column=0)
    entry_numero_livro_disponibilidade = tk.Entry(root)
    entry_numero_livro_disponibilidade.grid(row=17, column=1)

    tk.Label(root, text="Nova Disponibilidade").grid(row=18, column=0)
    ...
    entry_nova_disponibilidade.grid(row=18, column=1)
    tk.Button(root, text="Marcar Disponibilidade", command=marcar_disponibilidade_gui).grid(row=19, column=0, pady=5)

    tk.Button(root, text="Exportar para Excel", command=exportar_para_excel_gui).grid(row=19, column=1, pady=5)

    tk.Label(root, text="Número do Livro para Deletar").grid(row=20, column=0)
    entry_numero_livro_deletar = tk.Entry(root)
    entry_numero_livro_deletar.grid(row=20, column=1)
    tk.Button(root, text="Deletar Livro", command=deletar_livro_gui).grid(row=21, column=0, pady=5)

    tk.Label(root, text="Número do Livro para Editar").grid(row=22, column=0)
    entry_numero_livro_editar = tk.Entry(root)
    entry_numero_livro_editar.grid(row=22, column=1)
    tk.Button(root, text="Carregar Dados para Edição", command=carregar_dados_livro_gui).grid(row=23, column=0, pady=5)
    tk.Button(root, text="Editar Livro", command=editar_livro_gui).grid(row=23, column=1, pady=5)
